...
import { usePendingForApprovalContext } from './PendingForApprovalContextProvider';
...
const PendingForApprovalEdit = (props) => {
  const { profileID } = useAuthContext();
  const { allMembers, setAllMembers, fetchDataPendingForApproval } = usePendingForApprovalContext();
      ...
      <Box w="100%">
        ...
        <Flex
          ...
          <Flex w="100%" justifyContent="space-between">
            <Text fontSize="28px">Edit member</Text>{' '}
            <Flex>
              <Button
                m="0 5px"
                color="white"
...
export default PendingForApprovalEdit;
